...
public class Costum {
    public static void main(String[] args) {
        ...
        try {
            ...
            String pQuery = "select * from MyOfice.Customers where LastName like ?";
            PreparedStatement pstmt = conn.prepareStatement(pQuery);
            pstmt.setString(1,"Petr");
            ResultSet rs = pstmt.executeQuery(pQuery);
...
доделать это и расмотреть тему транзакций
       рассмотореть связь многое ко многим
узнать про режим автокомит
